...
/**
 * MultilingualCard - Large Bento card showcasing multilingual support
 * Displays animated conversation bubbles in different languages
 */
    ...
    <SpotlightCard className="md:col-span-6 lg:col-span-8 min-h-[250px] lg:min-h-[400px] flex flex-col justify-between">
      <div className="p-8 md:p-10 z-10 relative">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 max-w-md">
          Break language barriers instantly. Askly detects and responds in your student's native
          tongue, ensuring inclusivity from day one.
        </p>
      </div>
