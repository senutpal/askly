	...
	return (
		<div className="relative mx-auto h-[600px] w-[350px]">
			<div className="relative flex h-full flex-col">
				{isOpen && (
					<div className="absolute bottom-8 right-4 z-10 flex w-[300px] flex-col overflow-hidden rounded-2xl border bg-background shadow-xl">
			...
			{!isOpen && (
				<button
					...
					className="absolute bottom-0 right-0 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-lg hover:scale-105 transition-transform"
				>
