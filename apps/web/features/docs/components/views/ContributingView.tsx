			...
			<div className="space-y-24">
				...
				<section className="border-b border-zinc-200 dark:border-zinc-800 pb-12">
					<p className="text-lg text-zinc-600 dark:text-zinc-300 leading-relaxed">
						Thank you for your interest in contributing to Askly! This project
				...
				<section>
					...
					<div className="mt-8">
						<StepItem number="01" title="Fork and Clone">
							<p className="mb-4">
								Start by forking the repository to your GitHub account, then
								clone it locally.
							</p>
							<EnhancedCodeBlock
...
cd askly`}
						...
						<StepItem number="03" title="Create Branch">
							<p className="mb-4">
								Create a descriptive branch for your work. Avoid working
								directly on <code className="text-xs font-mono">main</code>.
							</p>
				...
				<section>
					<SectionHeading icon={GitPullRequest}>
							...
							<div className="grid divide-y md:divide-y-0 md:divide-x divide-zinc-200 dark:divide-zinc-800 md:grid-cols-2">
								<div className="p-6">
									<div className="flex items-center gap-2 mb-4">
										<div className="w-8 h-8 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center text-sm font-mono">
											1
										</div>
...
pnpm build`}
								...
								<div className="p-6">
									...
									<p className="text-sm text-zinc-500 mb-4">
										Push your changes and open a request on GitHub.
									</p>
									<EnhancedCodeBlock
										code={`git add .
...
git push origin feature/your-feature-name`}
				...
				<section>
					...
					<p className="mb-6 text-zinc-600 dark:text-zinc-400">
						We follow the Conventional Commits specification. This helps us
					...
					<div className="grid md:grid-cols-2 gap-6">
						...
						<div className="p-6 rounded-2xl border border-zinc-200 bg-zinc-50/50 dark:bg-zinc-900/20 dark:border-zinc-800">
							...
							<p className="text-sm text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
								Askly is licensed under the GNU General Public License v3.0. By
