			...
			<div className="space-y-24">
				...
				<section>
					...
					<p className="text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
						Askly is engineered as a modern, scalable monorepo comprising three
						distinct applications unified by a serverless backend. The
						architecture prioritizes type safety, real-time performance, and
				...
				<section>
					...
					<div className="mt-8">
						<StepItem number="01" title="User Interaction">
							<p>
								The user types a message in the Widget interface. The client
								performs an optimistic update to show the message immediately
								while sending a mutation to the Convex backend.
							</p>
						</StepItem>

						<StepItem number="02" title="Context Retrieval (RAG)">
							<p>
								The backend receives the message and generates a vector
								embedding. It performs a cosine similarity search against the
								stored knowledge base chunks to retrieve relevant institutional
								context.
							</p>
						</StepItem>
						...
						<StepItem number="03" title="AI Generation">
							<p>
								The retrieved context, along with conversation history, is
								injected into the system prompt. This payload is sent to Google
								Gemini to generate a response grounded in the provided data.
							</p>
						</StepItem>

						<StepItem number="04" title="Real-time Sync">
							<p>
								The AI response is streamed back to Convex, which pushes updates
								to the Widget via WebSockets. Simultaneously, the Dashboard
								receives these updates via reactive queries, allowing admins to
								monitor the chat in real-time.
							</p>
						</StepItem>
					</div>
				</section>
						...
						<div className="grid divide-y md:divide-y-0 md:divide-x divide-zinc-200 dark:divide-zinc-800 md:grid-cols-3">
							<div className="p-6">
								...
								<p className="text-sm text-zinc-500">
									PDFs and text documents are parsed, cleaned, and split into
									semantic chunks.
								</p>
							</div>
							<div className="p-6">
								...
								<p className="text-sm text-zinc-500">
									Chunks are converted to vector embeddings and stored in
									Convex's vector database.
								</p>
							</div>
							<div className="p-6">
								<div className="w-8 h-8 rounded-full bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center mb-4 text-zinc-500">
								...
								<p className="text-sm text-zinc-500">
									Queries trigger vector searches to find the most relevant
									chunks for context injection.
								</p>
							</div>
						</div>
					</div>
					...
					<div className="grid md:grid-cols-2 gap-6">
						<div className="p-6 rounded-2xl border border-zinc-200 bg-zinc-50/50 dark:bg-zinc-900/20 dark:border-zinc-800">
							...
							<p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed">
								Data isolation is enforced at the database query level. Every
								operation requires an Organization ID, ensuring complete
								separation of data between different campuses.
							</p>
							<ul className="space-y-2 text-sm text-zinc-500">
								<li className="flex gap-2">
									<div className="w-4 h-4 text-green-500">✓</div> Isolated
									knowledge bases
								</li>
								<li className="flex gap-2">
									<div className="w-4 h-4 text-green-500">✓</div> Separate
									analytics pipelines
								</li>
							</ul>
						</div>
						...
						<div className="p-6 rounded-2xl border border-zinc-200 bg-zinc-50/50 dark:bg-zinc-900/20 dark:border-zinc-800">
							...
							<p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed">
								All communications are encrypted via TLS. Authentication is
								handled via Clerk JWTs, and sensitive configuration is encrypted
								at rest using AES-256-GCM.
							</p>
							<ul className="space-y-2 text-sm text-zinc-500">
								<li className="flex gap-2">
									<div className="w-4 h-4 text-green-500">✓</div> Zod schema
									validation
								</li>
								<li className="flex gap-2">
									<div className="w-4 h-4 text-green-500">✓</div> Row-level
									security policies
								</li>
							</ul>
						</div>
					...
					<div className="flex gap-4">
						...
						<div>
							...
							<p className="text-sm text-blue-700 dark:text-blue-300 leading-relaxed">
								The architecture leverages Edge functions for low-latency
								responses and serverless databases that auto-scale with demand.
								Static assets are distributed via global CDNs, ensuring fast
								load times regardless of user location.
							</p>
						</div>
					</div>
				</div>
