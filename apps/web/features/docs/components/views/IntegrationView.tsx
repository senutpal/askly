			...
			<div className="space-y-24">
				...
				<section>
					...
					<p className="text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">
						The easiest way to add Askly to your website is with a single script
						tag. Add this to your HTML before the closing{" "}
					...
					<div className="mt-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/40 overflow-hidden">
						<div className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/20 flex items-center gap-2">
							...
							<h3 className="font-medium text-sm text-zinc-900 dark:text-zinc-200">
					...
					<div className="mt-6">
						<AlertBox type="info" title="Finding Your Organization ID">
							Go to your Askly dashboard, then navigate to{" "}
							<strong>Configurations → Integrations</strong>. Copy the
							Organization ID shown there to connect the widget to your
							knowledge base.
						</AlertBox>
					</div>
				</section>
				...
				<section>
					...
					<p className="text-zinc-600 dark:text-zinc-400 mb-6">
						Once the script is loaded, you can control the widget
						programmatically using the global window object.
					</p>

					<EnhancedCodeBlock
						code={codeExamples.programmaticControl}
						language="javascript"
					/>
					...
					<div className="space-y-12">
						...
						<div>
							...
							<p className="text-zinc-600 dark:text-zinc-400 mb-4">
								Use the{" "}
								<code className="px-1.5 py-0.5 bg-zinc-100 dark:bg-zinc-800 rounded text-sm font-mono">
									useEffect
								</code>{" "}
								hook to load the widget when the component mounts.
							</p>
							<EnhancedCodeBlock
								code={codeExamples.embedReact}
								language="javascript"
								filename="App.jsx"
							/>
						</div>
						...
						<div>
							...
							<div className="mt-4 text-sm text-zinc-500">
								...
								Use{" "}
								<code className="font-mono text-xs">strategy="lazyOnload"</code>{" "}
								to improve your Core Web Vitals by deferring the widget load.
							</div>
						</div>
  ...
  beforeUnmount() {
    window.AsklyWidget?.destroy();
				...
				<section>
					...
					<p className="text-zinc-600 dark:text-zinc-400 mb-6">
						Control the widget placement using the{" "}
						<code className="px-1.5 py-0.5 bg-zinc-100 dark:bg-zinc-800 rounded text-sm font-mono">
							data-position
						</code>{" "}
						attribute.
					...
					<div className="grid md:grid-cols-2 gap-6">
						...
						>
							<div className="flex items-center gap-2 mb-3">
								...
								<span className="text-xs bg-zinc-200 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 px-2 py-0.5 rounded-full">
									Default
								</span>
							</div>
							<p className="text-sm text-zinc-500 mb-4">
								Standard placement. Recommended for most websites to align with
						...
						>
							...
							<p className="text-sm text-zinc-500 mb-4">
								Alternative placement. Useful if you have back-to-top buttons or
								other FABs on the right.
							</p>
							<code className="text-xs bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 px-2 py-1 rounded text-zinc-600 dark:text-zinc-400">
					...
					<div className="bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-1">
						<div className="grid divide-y md:divide-y-0 md:divide-x divide-zinc-200 dark:divide-zinc-800 md:grid-cols-2 lg:grid-cols-4">
							{[
								{
									title: "Widget Load",
									desc: "Reload page to confirm the button appears in the configured position.",
								},
								{
									title: "Open Interface",
									desc: "Click the launcher. Ensure the chat window opens smoothly.",
								},
								{
									title: "AI Response",
									desc: "Send a test message. Verify the AI answers from your knowledge base.",
								},
								{
									title: "Dashboard",
				...
				<section>
					...
					<div className="grid sm:grid-cols-2 gap-4">
						{[
							{
								text: "Load script asynchronously to avoid blocking UI",
								icon: Zap,
							},
							{
								text: "Test on mobile devices for responsiveness",
								icon: Smartphone,
							},
