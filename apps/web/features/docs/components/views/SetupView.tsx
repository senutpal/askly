			...
			<div className="space-y-16">
				...
				<section>
					<p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed">
						Askly operates as a monorepo requiring specific environment
						variables for each application. Ensure these are configured
						correctly to enable communication between the dashboard, widget, and
						backend services.
					</p>
				</section>
							...
							items={[
								{
									...
									desc: "Found in Clerk Dashboard → API Keys.",
								},
								{
									key: "CLERK_SECRET_KEY",
									desc: "Secret key from the same page. Keep this private.",
								},
							]}
						/>
						<ConfigCard
							...
							items={[
								{
									...
									desc: "Your deployment URL from the Convex dashboard.",
								},
								{
									key: "CONVEX_DEPLOYMENT",
									desc: "The deployment name generated during setup.",
								},
							]}
						/>
						<ConfigCard
							...
							items={[
								{
									...
									desc: "Where the widget runs (localhost:3001 for dev).",
								},
								{
									key: "NEXT_PUBLIC_APP_URL",
									desc: "The main dashboard URL (localhost:3000 for dev).",
								},
							]}
						/>
					</div>
							...
							items={[
								{
									...
									desc: "Public key available in your Vapi dashboard.",
								},
								{
									key: "VAPI_PRIVATE_KEY",
									desc: "Private key used for server-side signing.",
								},
							]}
						/>
						<p className="mt-4 text-sm text-zinc-500">
							Don't have keys? Sign up at{" "}
							<a
								href="https://vapi.ai"
								target="_blank"
				...
				<section>
					...
					<EnhancedCodeBlock
						code={envExamples.embed}
						language="bash"
						filename="apps/embed/.env"
					/>
					...
					<div className="mt-4 p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50 flex gap-3">
						...
						<p className="text-sm text-zinc-600 dark:text-zinc-400">
							<strong>Widget URL:</strong> This points to your hosted widget
							application. In production, this would be{" "}
					...
					<div className="grid md:grid-cols-2 gap-6 mt-6">
						<ConfigCard
							...
							items={[
								...
								{
									key: "VAPI_API_KEY",
									desc: "Server-side API key (different from the public key).",
								},
							]}
						/>
						<ConfigCard
							...
							items={[
								{
									key: "MASTER_KEY",
									desc: "32+ char random string used for internal encryption.",
								},
							]}
						/>
					</div>
				...
				<section>
					...
					<div className="mt-8">
						<StepItem number="01" title="Create Application">
							...
							, create a new application, and select your preferred social login
							providers.
						</StepItem>

						<StepItem number="02" title="Enable Organizations">
							Navigate to the <strong>Organizations</strong> tab in the Clerk
							sidebar and toggle the feature on. This is required for
							multi-tenancy support.
						</StepItem>

						<StepItem number="03" title="Configure Callbacks">
							Add the following URLs to your allowed callback list in the Clerk
							dashboard:
					...
					<div className="grid md:grid-cols-2 gap-6 mt-6">
						<div className="p-6 rounded-2xl border border-zinc-200 bg-white dark:bg-zinc-900/40 dark:border-zinc-800">
							...
							<p className="text-sm text-zinc-500 mb-4">
								Run the setup script to automatically create your project and
								configure schemas.
							</p>
						...
						<div className="flex items-start gap-4">
							...
							<div>
								...
								<ul className="space-y-2 text-sm text-amber-800 dark:text-amber-400/80">
									...
									<li className="flex items-center gap-2">
										<span className="w-1 h-1 rounded-full bg-amber-500" />
										Use distinct API keys for development vs. production
										environments.
									</li>
									<li className="flex items-center gap-2">
										<span className="w-1 h-1 rounded-full bg-amber-500" />
										Ensure your{" "}
										<code className="font-mono text-xs">MASTER_KEY</code> is a
