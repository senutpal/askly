...
import { ProblemCard } from "../shared/ProblemCard";
			...
			<div className="space-y-20 pb-10">
					...
					>
						<div className="relative z-10">
							<p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-3xl">
								Askly is an open-source conversational platform engineered to
								eliminate language barriers in education. It combines{" "}
								...
								to provide 24/7 automated support capable of handling thousands
								of concurrent student queries.
							</p>
						</div>
				...
				<section>
					...
					>
						...
						<div>
							<h4 className="text-emerald-900 dark:text-emerald-400 font-medium">
								Measurable Impact
							</h4>
							<p className="text-emerald-800/80 dark:text-emerald-400/80 text-sm mt-1">
								Deployments show a <strong>70% reduction</strong> in repetitive
								front-desk queries, allowing staff to focus on complex student
								counseling.
							</p>
						</div>
					</motion.div>
						...
						{[
							{
								...
								desc: "Native language detection",
							},
							{
								icon: BrainCircuit,
								label: "Conversation Memory",
								desc: "Multi-turn context retention",
							},
							{
								icon: Server,
								label: "Knowledge Integration",
								desc: "PDF, Docx, & Web sources",
							},
							{
								icon: Mic,
								label: "Voice Calls",
								desc: "Real-time audio processing",
							},
							{
								icon: BarChart3,
								label: "Analytics",
								desc: "Usage & query insights",
							},
							{
								icon: ShieldCheck,
					...
					<div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-zinc-50 dark:bg-zinc-900/50 p-8 rounded-2xl border ">
						<div>
							...
							<p className="text-zinc-500 dark:text-zinc-400 max-w-md">
								Jump straight into the installation guide to set up Askly on
