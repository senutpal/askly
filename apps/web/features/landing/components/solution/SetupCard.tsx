...
/**
 * SetupCard - Large card showcasing quick setup process
 * Features floating UI mockup with 3D hover effect
 */
        ...
        <div className="flex-1 space-y-6">
          ...
          <div>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-sm">
              Simply upload your documents. Askly trains itself instantly. No coding, no complex
              flowcharts.
            </p>
          </div>
        </div>
